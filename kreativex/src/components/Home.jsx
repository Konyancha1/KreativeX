    ...
    return (
        <div>
            ...
            <div className='relative mt-[15rem] flex flex-col mb-24' ref={servicesRef}>
                ...
                <div className='w-[w-90%] md:w-[80%] mx-auto'>
                    <div className='grid lg:flex grid-cols-1 md:grid-cols-2 lg:flex-row mx-auto gap-6 mt-10'>
                        <div class='bg-white p-5 h-72 md:w-3/4 w-2/3 mx-auto mt-5 rounded-lg flex flex-col justify-center items-center'>
                            <h1 class='text-center font-bold text-lg md:text-xl text-red-500 mb-6'>Content Creation</h1>
                            <p class='text-center'>Develop and Produce Valuable and Relevant Content for You To Attract and Retain Customers</p>
                        </div>
                        <div class='bg-white p-5 h-72 md:w-3/4 w-2/3 mx-auto mt-5 rounded-lg flex flex-col justify-center items-center'>
                            <h1 class='text-center font-bold text-lg md:text-xl text-red-500 mb-6'>Website Development, Data Analytics and SEO</h1>
                        ...
                        <div class='bg-white p-5 h-72 md:w-3/4 w-2/3 mx-auto mt-5 rounded-lg flex flex-col justify-center items-center'>
                            <h1 class='text-center font-bold text-lg md:text-xl text-red-500 mb-6'>Financial Analytics</h1>
                        ...
                        <div class='bg-white p-5 h-72 md:w-3/4 w-2/3 mx-auto mt-5 rounded-lg flex flex-col justify-center items-center'>
                            <h1 class='text-center font-bold text-lg md:text-xl text-red-500 mb-6'>Talent Training and Management</h1>
            ...
            <div class='grid grid-cols-3 gap-4 mx-auto w-[80%] md:w-[50%] mb-20'>
            ...
            <footer className='bottom-0 px-16 h-10 mx-auto flex items-center w-full bg-white'>
                <p className='mx-auto text-sm md:text-base'>© 2023 KreativeX. All rights reserved.</p>
            </footer>
        </div>
    )
}
